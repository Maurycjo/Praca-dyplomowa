...
\title{Budowa narzędzia wspomagającego pracę zespołu obsługi klienta i
wsparcia technicznego w zakresie zarządzania obsługiwanym sprzętem} % INFO: tytuł pracy w języku polskim 
\titleShort{Budowa narzędzia zarządzania obsługiwanym sprzętem}  % INFO: krótki tytuł pracy (do zamieszczenia w stopce, sklejony z imieniem i nazwiskiem autora nie powinien zająć więcej niż jedną linijkę)
\titleEN{Creating a tool to assist the customer service and technical support
team in managing supported equipment} % INFO: tytuł pracy w języku angielskim
