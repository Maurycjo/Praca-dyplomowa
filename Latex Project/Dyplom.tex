...
%Tabele przypadków użycia by Maurycy Niewczas
\usepackage{enumitem}
...
\title{Budowa narzędzia wspomagającego zarządzanie sprzętem komputerowym} % INFO: tytuł pracy w języku polskim 
\titleShort{Budowa narzędzia wspomagającego zarządzanie \ldots}  % INFO: krótki tytuł pracy (do zamieszczenia w stopce, sklejony z imieniem i nazwiskiem autora nie powinien zająć więcej niż jedną linijkę)
\titleEN{Building a tool to support the management of computer equipment} % INFO: tytuł pracy w języku angielskim
...
\kvpl{inwentaryzacja sprzętu, loteria sprzętu, aplikacja internetowa} % INFO: słowa kluczowe po polsku
\kven{inventory of device, lottery of device, web application} % INFO: słowa kluczowe po angielsku
