...
\begin{tabularx}{\linewidth}{|X|l|p{3cm}|X|}
    ...
    \hline
		 /computers/update/id & PUT & id sprzętu oraz zmienione dane sprzętu& aktualizacja danych komputera\\
		\hline
		 /tablets/update/id & PUT & id sprzętu oraz zmienione dane sprzętu& aktualizacja danych tabletu\\
		\hline	 
		/other-device/update/id & PUT & id sprzętu i zmienione dane sprzętu & aktualizacja danych innego urządzenia\\
		\hline
