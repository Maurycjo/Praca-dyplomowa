...
\label{rozdzial:integracja_bazy_danych}
...
\begin{figure}[ht] % TO DO: prosiłem, by rysunki z podrysunkami robić za pomocą tabel - to jest wyjaśnione w szablonie pracy !!!!!!
