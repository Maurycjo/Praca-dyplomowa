...
\begin{figure}[htb]
  \centering
	\begin{tabular}{@{}lll@{}}
	a) & b) & c) \\
  \vtop{\vskip-2ex\hbox{\includegraphics[width=0.2\textwidth]{rys05/frontend/frontend.pdf}}} & 
	\vtop{\vskip-2ex\hbox{\includegraphics[width=0.25\textwidth]{rys05/frontend/auth.pdf}}} &
	\vtop{\vskip-2ex\hbox{\includegraphics[width=0.25\textwidth]{rys05/frontend/bar.pdf}}} \\

	d) & e) & f) \\
	\vtop{\vskip-2ex\hbox{\includegraphics[width=0.25\textwidth]{rys05/frontend/components.pdf}}} &
	\vtop{\vskip-2ex\hbox{\includegraphics[width=0.25\textwidth]{rys05/frontend/deviceform.pdf}}} &
	\vtop{\vskip-2ex\hbox{\includegraphics[width=0.25\textwidth]{rys05/frontend/view.pdf}}}
	\end{tabular}
