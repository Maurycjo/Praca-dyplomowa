...
\begin{itemize}
	...
	\item W-6 - Widok komponentów komputera, rysunek 
	\item W-7 - Widok formularzy komponentów komputera, rysunek
\end{itemize} 
...
\begin{figure}[h]
		\centering
    \includegraphics[width=0.7\linewidth]{rys05/view/lotteryHistory.pdf}
...
\begin {itemize}
	...
	\item Kliknięcie przycisku "`Wypisz się"' możliwe jest wtedy kiedy loteria się jeszcze nie odbyła. Po kliknięcui tego przycisku pracownik rezygnuje z uczestnictwa w losowaniu wybranego sprzętu.
\end{itemize} 
